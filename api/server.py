...
class FilesResponse(BaseResponse):
    ...
    data: List[FileRecord] = Field(..., description="List of files")
    pagination: PaginationInfo = Field(..., description="Pagination information")


class FileRecordResponse(BaseResponse):
    """Single file response model."""

    data: FileRecord = Field(..., description="File data")
...
class ClassesResponse(BaseResponse):
    ...
    data: List[ClassRecord] = Field(..., description="List of classes")
    pagination: PaginationInfo = Field(..., description="Pagination information")
...
class FunctionsResponse(BaseResponse):
    ...
    data: List[FunctionRecord] = Field(..., description="List of functions")
    pagination: PaginationInfo = Field(..., description="Pagination information")
...
class ServicesResponse(BaseResponse):
    ...
    data: List[ServiceRecord] = Field(..., description="List of services")
    pagination: PaginationInfo = Field(..., description="Pagination information")
...
db_path = project_root / "docs" / "interactive-documentation-suite" / "documentation.db"
...
async def dashboard() -> Union[FileResponse, JSONResponse]:
...
) -> Union[FilesResponse, JSONResponse]:
...
async def get_file(file_id: int) -> Union[FileRecordResponse, JSONResponse]:
...
async def get_file_detailed(file_id: int) -> Union[DetailedFileResponse, JSONResponse]:
...
) -> Union[ClassesResponse, JSONResponse]:
...
) -> Union[FunctionsResponse, JSONResponse]:
    ...
    try:
        ...
        return JSONResponse(
            ...
            content=ErrorResponse(
                error=f"Failed to load functions: {str(e)}"
            ).model_dump(),
        )
...
) -> Union[ServicesResponse, JSONResponse]:
...
async def search_code(
    ...
    search_type: str = Query("all", regex="^(all|files|classes|functions)$"),
...
async def get_domains() -> Union[DomainsResponse, JSONResponse]:
...
async def get_complexity_distribution() -> Union[ComplexityResponse, JSONResponse]:
...
async def debug_test() -> Union[DebugResponse, JSONResponse]:
